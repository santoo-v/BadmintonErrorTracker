...
errorForm.addEventListener('submit', async e => {
  ...
  const entry = {
    ...
    set: document.getElementById('set').value, rally: document.getElementById('rally').value,
    errorType: document.getElementById('errorType').value, zone: document.getElementById('zone').value,
